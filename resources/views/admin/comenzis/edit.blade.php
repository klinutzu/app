...
<div class="card">
    <div class="card-header">
        {{ trans('global.edit') }} {{ trans('cruds.comenzi.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.comenzis.update", [$comenzi->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('initiator') ? 'is-invalid' : '' }}" name="initiator_id" id="initiator_id" required>
                    @foreach($initiators as $id => $entry)
                        <option value="{{ $id }}" {{ (old('initiator_id') ? old('initiator_id') : $comenzi->initiator->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('presales') ? 'is-invalid' : '' }}" name="presales_id" id="presales_id" required>
                    @foreach($presales as $id => $entry)
                        <option value="{{ $id }}" {{ (old('presales_id') ? old('presales_id') : $comenzi->presales->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('data_init') ? 'is-invalid' : '' }}" type="text" name="data_init" id="data_init" value="{{ old('data_init', $comenzi->data_init) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('nume_client') ? 'is-invalid' : '' }}" type="text" name="nume_client" id="nume_client" value="{{ old('nume_client', $comenzi->nume_client) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('pers_contact') ? 'is-invalid' : '' }}" type="text" name="pers_contact" id="pers_contact" value="{{ old('pers_contact', $comenzi->pers_contact) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('telefon') ? 'is-invalid' : '' }}" type="text" name="telefon" id="telefon" value="{{ old('telefon', $comenzi->telefon) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('adresa') ? 'is-invalid' : '' }}" type="text" name="adresa" id="adresa" value="{{ old('adresa', $comenzi->adresa) }}" required>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('servicius') ? 'is-invalid' : '' }}" name="servicius[]" id="servicius" multiple required>
                    @foreach($servicius as $id => $serviciu)
                        <option value="{{ $id }}" {{ (in_array($id, old('servicius', [])) || $comenzi->servicius->contains($id)) ? 'selected' : '' }}>{{ $serviciu }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('cost_total') ? 'is-invalid' : '' }}" type="text" name="cost_total" id="cost_total" value="{{ old('cost_total', $comenzi->cost_total) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('cost_lunar') ? 'is-invalid' : '' }}" type="text" name="cost_lunar" id="cost_lunar" value="{{ old('cost_lunar', $comenzi->cost_lunar) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('numar_comanda') ? 'is-invalid' : '' }}" type="text" name="numar_comanda" id="numar_comanda" value="{{ old('numar_comanda', $comenzi->numar_comanda) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('numar_ariba') ? 'is-invalid' : '' }}" type="text" name="numar_ariba" id="numar_ariba" value="{{ old('numar_ariba', $comenzi->numar_ariba) }}">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('observatii') ? 'is-invalid' : '' }}" name="observatii" id="observatii">{{ old('observatii', $comenzi->observatii) }}</textarea>
